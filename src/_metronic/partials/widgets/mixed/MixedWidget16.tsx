...
const MixedWidget16: FC<Props> = ({ className, chartColor, chartHeight }) => {
			...
			<div className="card-header border-0 pt-5">
				<div className="card-toolbar">
					...
					<ul className="nav">
						...
						<li className="nav-item">
							<button
								className={`nav-link btn btn-sm btn-color-muted btn-active btn-active-light-success fw-bold px-4 ${
									type === "yearly" ? "active" : ""
								}`}
