...
const VeterinariansEditModalForm: FC<Props> = ({user, isUserLoading}) => {
  ...
  return (
    <>
      ...
      {(formik.isSubmitting || isUserLoading) && <VeterinariansListLoading />}
    </>
  )
}

export {VeterinariansEditModalForm}
