...
const PetMedicationsTable = () => {
	const users = useQueryResponseData();
	const isLoading = useQueryResponseLoading();
	const data = useMemo(() => users, [users]);
	const columns = useMemo(() => petMedicationsColumns, []);
	...
	return (
		<KTCardBody className="py-4">
			...
			<PetMedicationsListPagination />
			{isLoading && <PetMedicationsListLoading />}
		</KTCardBody>
	);
};

export { PetMedicationsTable };
